...
(function () {
  const SITE = {
    ...
    defaultDescription:
      "أكاديمية المسارحة لكرة القدم في السعودية — تسجيل لاعبين، فرق، مباريات، متجر، وأخبار محدّثة.",
    locale: "ar_SA",
  ...
  const PAGE_SEO = {
    ...
    "al_masariha_join_page.html": {
      ...
      description:
        "قدّم طلب انضمام كلاعب أو ولي أمر أو كادر، واحتفظ برقم المرجع للمتابعة."
    },
